...
class SerializerCreator implements SerializerClasses
{
    ...
    {
        @Override public int compare(final JField o1, final JField o2)
        {
    ...
    private void recursivelyCreateSerializers(final TreeLogger logger, final JType targetType) throws UnableToCompleteException
    {
    ...
    private boolean ensureSerializersForTypeParameters(final TreeLogger logger, final JType type) throws UnableToCompleteException
    {
    ...
    void checkCanSerialize(final TreeLogger logger, final JType type, boolean allowAbstractType) throws UnableToCompleteException
    {
    ...
    String serializerFor(final JType t)
    {
        if (t.isArray() != null)
        {
            ...
            if (componentType.isPrimitive() != null || isBoxedPrimitive(componentType))
                ...
                return ObjectArraySerializer + "<" + componentType.getQualifiedSourceName() + ">";
        }
    ...
    private SourceWriter getSourceWriter(final TreeLogger logger, final GeneratorContext ctx)
    {
        ...
        if (targetType.isEnum() != null)
        {
            ...
            cf.setSuperclass(EnumSerializer_simple + "<" + targetType.getQualifiedSourceName() + ">");
        }
        ...
        else
        {
            ...
            cf.setSuperclass(ObjectSerializer_simple + "<" + targetType.getQualifiedSourceName() + ">");
        }
