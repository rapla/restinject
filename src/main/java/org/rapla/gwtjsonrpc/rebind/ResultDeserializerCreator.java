...
class ResultDeserializerCreator {
  ...
  private SourceWriter getSourceWriter(TreeLogger logger,
    ...
    cf.addImport(SerializerClasses.ResultDeserializer);

    cf.setSuperclass(SerializerClasses.ArrayResultDeserializer);
    cf.addImplementedInterface(SerializerClasses.ResultDeserializer
