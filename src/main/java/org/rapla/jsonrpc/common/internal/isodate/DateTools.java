 ...
 *--------------------------------------------------------------------------*/
package org.rapla.jsonrpc.common.internal.isodate;
...
import java.util.Locale;
 ...
 //    }
    ...
    {
        long millisTime = time.getTime() - cutDate(time.getTime());
        Date result = new Date( cutDate(date.getTime()) + millisTime);
        return result;
    }
     ...
     {
         if(isUsStyle(getCountry(locale)))
         {
